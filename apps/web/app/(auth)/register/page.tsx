...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      // TODO: conectar con POST /users/register
      // const res = await fetch(`${process.env.NEXT_PUBLIC_USER_SERVICE_URL}/users/register`, {
      //   method: 'POST',
      ...
      // Mock: redirigir a login tras registro
      router.push('/login')
    } catch (err) {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-white mb-1">Crear cuenta</h1>
          <p className="text-sm" style={{ color: '#64748B' }}>Únete a HomeOS</p>
        </div>
